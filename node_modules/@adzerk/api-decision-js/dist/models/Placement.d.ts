...
export declare function PlacementFromJSON(json: any): Placement;
export declare function PlacementFromJSONTyped(json: any, ignoreDiscriminator: boolean): Placement;
export declare function PlacementToJSON(value?: Placement | null): any;
